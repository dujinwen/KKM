...
public class MultipleStatusView extends RelativeLayout {
    ...
    private static final LayoutParams DEFAULT_LAYOUT_PARAMS_MARGIN_TOP =
            new LayoutParams(LayoutParams.MATCH_PARENT,
                    LayoutParams.MATCH_PARENT);
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.common_error_view);
        ...
        DEFAULT_LAYOUT_PARAMS_MARGIN_TOP.setMargins(0, (int) getResources().getDimension(R.dimen.work_item_title_hight), 0, 0);
    }
     ...
     * @param needMarginTop 是否需要距离顶部的留白
     */
    public final void showError(int layoutId, boolean needMarginTop) {
        showError(inflateView(layoutId), needMarginTop ? DEFAULT_LAYOUT_PARAMS_MARGIN_TOP : DEFAULT_LAYOUT_PARAMS);
    }
     ...
     * @param needMarginTop 是否需要距离顶部的留白
     */
    public final void showLoading(int layoutId, boolean needMarginTop) {
        showLoading(inflateView(layoutId), needMarginTop ? DEFAULT_LAYOUT_PARAMS_MARGIN_TOP : DEFAULT_LAYOUT_PARAMS);
    }
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(R.id.common_no_network_retry_view);
    ...
    private boolean isOutContentView = false;

    public void setIsOutContentView(boolean isOutContentView) {
        this.isOutContentView = isOutContentView;
    }

    public void showOutContentView(View outView) {
        isOutContentView = true;
        mContentView = outView;
        showContentView();
    }
