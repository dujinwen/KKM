...
//    private float mMaxTextSize = context.getResources().getDimension(R.dimen.date_max_text_size);
//    private float mMinTextSize = context.getResources().getDimension(R.dimen.date_min_text_size);
    private float mMaxTextSize = getResources().getDimension(R.dimen.date_max_text_size);
    private float mMinTextSize = getResources().getDimension(R.dimen.date_min_text_size);
    ...
    private void drawData(Canvas canvas) {
        ...
        mPaint.setTextSize(getResources().getDimension(R.dimen.date_max_text_size));
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        ...
        float size = (mMaxTextSize - mMinTextSize) * scale + mMinTextSize;
        nPaint.setTextSize(getResources().getDimension(R.dimen.date_min_text_size));
